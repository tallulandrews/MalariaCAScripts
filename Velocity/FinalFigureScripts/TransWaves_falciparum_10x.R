...
source("~/R-Scripts/Blank_plot.R")
png("Explain_My_Pseudotime2_falciparum.png", width=7.5, height=6, units="in", res=300)
layout(mat=cbind(c(1,1), c(2,2)), width=c(3.5,1), heights=c(1,1))
par(mar=c(4,4,1,0))
...
lines(c(plot_fit[20,1], fitg[1,1], dat_10X$ann[start_cell,"pc1"]), 
      c(plot_fit[20,2], fitg[2,1], dat_10X$ann[start_cell,"pc2"]), col="black", lwd=2) 

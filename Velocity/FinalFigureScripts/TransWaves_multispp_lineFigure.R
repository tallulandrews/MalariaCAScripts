...
knowlesi_dat_10X <- readRDS("knowlesi_10X_velodata.rds")
knowlesi_velo_10X <- readRDS("knowlesi_10X_veloEst.rds")
...
pdf("Three_Spp_Wave_Lines.pdf", width=7, height=9)
...
pdf("falciparum_four_data_wave_suppl.pdf", width=7, height=9)
layout(matrix(rep(1:4, each=2), ncol=2, byrow=T), widths=c(1,1), heights=c(1, 0.95, 0.95, 1.3))
par(mar=c(0,4,1,1))
